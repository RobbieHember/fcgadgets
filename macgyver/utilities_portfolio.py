...
def PlotResults(meta,mos,t_start,t_end,iBAU,iCAPa,iCAPb):
    ...
    for op in ListOp:
        ...
        for iV in range(len(ListV)):
            ...
            ax[0].set(position=[0.06,0.08,0.27,0.68],xlim=[tv[iT[0]],tv[iT[-1]]],ylabel=lab)
            ax[0].legend(loc='upper center',ncol=2,bbox_to_anchor=(0.5,1.21),frameon=False,facecolor=None)
            ...
            ax[1].legend(loc='upper center',bbox_to_anchor=(0.5,1.27),frameon=False,facecolor=None)
            ax[1].set(position=[0.4,0.08,0.27,0.68],xlim=[tv[iT[0]],tv[iT[-1]]],ylabel='$\Delta$ ' + lab)
