...
def Plot_HarvestAreaTimeSeries(meta,tlim):
    ...
    plt.close('all'); fig,ax=plt.subplots(1,figsize=gu.cm2inch(20,8));
...
def PlotInsectComp1_TS(meta):
	...
	plt.tight_layout()
	gu.axletters(ax,plt,0.03,0.9,FontColor=meta['Graphics']['gp']['cla'],LetterStyle=meta['Graphics']['Modelling']['AxesLetterStyle'],FontWeight=meta['Graphics']['Modelling']['AxesFontWeight'],Labels=lab,LabelSpacer=0.025)
	if meta['Graphics']['Print Figures']=='On':
