...
def PlotHarvestRemovals(meta,mos,tv,AEF,iScn,iT,iPS,iSS,flg_ann,flg_dead,flg_hbs):
    ...
    if flg_hbs==1:
        ...
        ax.plot(H_HBS['Year'],H_HBS['V All m3']/1e6,color=[0.5,0.95,0],lw=1.25,label='Tot. merch. vol. (HBS)')
...
def PlotVolumePerHectare(meta,mos,tv,iScn,iT,iPS,iSS,AEF):
    ...
    ax.set(position=[0.1,0.12,0.88,0.84],xticks=np.arange(tv[iT[0]],2250,5),xlabel='Time, years', \
           ylim=[200,1220],yticks=np.arange(0,2000,100),ylabel='Harvest volume (m$^3$ ha$^-$$^1$)',xlim=[tv[iT[0]]-0.5,tv[iT[-1]]+0.5])
...
def PlotComparisonWithPIR(meta,mos,tv,AEF,iScn,iT,iPS,iSS):
    ...
    ax[0,0].set(position=[0.08,0.59,0.41,0.4],xticks=np.arange(tv[iT[0]],2250,20),ylim=[-100,60],yticks=np.arange(-120,300,20),
           ylabel='Growth - Decay (MtCO$_2$e yr$^-$$^1$)',xlabel='Time, years',xlim=[tv[iT[0]]-0.5,tv[iT[-1]]+0.5])
    ...
    ax[0,1].set(position=[0.57,0.59,0.41,0.4],xticks=np.arange(tv[iT[0]],2250,20),ylim=[0,220],yticks=np.arange(0,300,25),
           ylabel='Wildfire (MtCO$_2$e yr$^-$$^1$)',xlabel='Time, years',xlim=[tv[iT[0]]-0.5,tv[iT[-1]]+0.5])
    ...
    ax[1,0].set(position=[0.08,0.09,0.41,0.4],xticks=np.arange(tv[iT[0]],2250,20),ylim=[0,100],yticks=np.arange(-120,300,20),
           ylabel='HWP (MtCO$_2$e yr$^-$$^1$)',xlabel='Time, years',xlim=[tv[iT[0]]-0.5,tv[iT[-1]]+0.5])
    ...
    ax[1,1].set(position=[0.57,0.09,0.41,0.4],xticks=np.arange(tv[iT[0]],2250,20),ylim=[-150,250],yticks=np.arange(-150,300,50),
           ylabel='GHG balance (MtCO$_2$e yr$^-$$^1$)',xlabel='Time, years',xlim=[tv[iT[0]]-0.5,tv[iT[-1]]+0.5])
