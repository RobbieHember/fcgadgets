...
d={}
d['Year']=tv
d['BaseCase']={'Coast':{},'Interior':{},'GFS22':{}}
d['S1']={'Coast':{},'Interior':{},'GFS22':{}}
...
ax[0,0].plot(tv,d['S1'][reg]['BiomassMerch_Removed'],'g--',label='Scenario 1',lw=lw,color=cl2)
...
ax[0,1].plot(tv,d['S1'][reg]['BiomassMerch_Piled'],'g--',label='Scenario 1',lw=lw,color=cl2)
...
ax[0,2].plot(tv,d['S1'][reg]['BiomassMerch_LeftOnSite'],'g--',label='Scenario 1',lw=lw,color=cl2)
...
ax[1,0].plot(tv,d['S1'][reg]['BiomassNonMerch_Removed'],'g--',label='Scenario 1',lw=lw,color=cl2)
...
ax[1,1].plot(tv,d['S1'][reg]['BiomassNonMerch_Piled'],'g--',label='Scenario 1',lw=lw,color=cl2)
...
ax[1,2].plot(tv,d['S1'][reg]['BiomassNonMerch_LeftOnSite'],'g--',label='Scenario 1',lw=lw,color=cl2)
...
ax[2,0].plot(tv,d['S1'][reg]['Snags_Removed'],'g--',label='Scenario 1',lw=lw,color=cl2)
...
ax[2,1].plot(tv,d['S1'][reg]['Snags_Piled'],'g--',label='Scenario 1',lw=lw,color=cl2)
...
ax[2,2].plot(tv,d['S1'][reg]['Snags_LeftOnSite'],'g--',label='Scenario 1',lw=lw,color=cl2)
